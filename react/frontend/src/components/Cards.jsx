const Cards = (props) => {
    ...
    return ( 
        data.map((product) => {
            ...
            return(<div key={product.uu_id} className="relative flex flex-col shadow-md rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 max-w-sm">
                ...
                <div className="h-auto overflow-hidden">
                    <div className="h-44 overflow-hidden relative">
                        <img src={product.machineImage} alt="" />
                    </div>
                </div>
                <div className="bg-white dark:bg-[#364350] py-4 px-3">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="relative z-40 flex items-center gap-2">
                            ...
                            <a className="text-orange-600 hover:text-blue-500" href={`/product-details/${product.uu_id}`}>
