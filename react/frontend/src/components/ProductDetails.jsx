...
const ProductDetails = () => {
  ...
  const {data: products, isPending, err}= useFetchData_From_Custom_API(`${api_url}/${id}`)
    ...
    return ( 
      ...
      <section className="text-gray-700 bg-white-900 body-font overflow-hidden">
        ...
        {products && <div className="container px-5 py-24 mx-auto">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h1 className="text-black dark:text-white text-3xl title-font font-medium mb-1">The Catcher in the Rye</h1>
              <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <span className="ml-3 dark:text-gray-200 text-gray-800">4 Reviews</span>
                </span>
                <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-800 text-gray-800 space-x-2">
                  <a>
              ...
              <p className="leading-relaxed dark:text-gray-200 text-gray-800">Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.</p>
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                <div className="flex">
                  <span className="mr-3 dark:text-gray-200 text-gray-800">Color</span>
                ...
                <div className="flex ml-6 items-center">
                  <span className="mr-3 dark:text-gray-200 text-gray-800">Size</span>
                  <div className="relative">
                    <select className="rounded border border-gray-700 focus:ring-2 focus:ring-indigo-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-indigo-500 dark:text-white text-black pl-3 pr-10">
                      <option>SM</option>
                      <option>M</option>
                      <option>L</option>
                      <option>XL</option>
